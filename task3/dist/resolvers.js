...
export const resolvers = {
    Query: {
        //READ 
        getSimulationParameter: async (_, args) => {
    ...
    Mutation: {
        //CREATE
        createSimulationParameters: async (_, args) => {
        ...
        //UPDATE
        updateSimulationParameters: async (_, args) => {
        ...
        //DELETE
        deleteSimulationParameters: async (_, args) => {
        ...
        runOurSimulation: async (_, { simulationParameters }) => {
